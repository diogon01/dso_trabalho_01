...
public class Usuarios  implements java.io.Serializable {
    ...
    public Usuarios(String nome, String cpf, String rg, String senha, String tipo, Date dtNascimento, String nrTelefone, String dsEndereco, Set alunoLinguas, Set professorLinguas) {
       this.nome = nome;
       this.cpf = cpf;
       this.rg = rg;
       this.senha = senha;
